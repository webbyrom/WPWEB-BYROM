<?php
	...
	$atts          = wp_parse_args( $atts, array(
		'title'    => esc_html__( 'Login Register', 'Webbyrom' ),
		'style'    => 'fs-popup',
		'type'     => 'both',
		'num_link' => '1',
		'active'   => 'login'
	...
	$settings      = fs_get_option( array(
		...
		esc_html__( 'Login', 'Webbyrom' ),
		esc_html__( 'Register', 'Webbyrom' ),
		esc_html__( 'Sign in', 'Webbyrom' ),
		esc_html__( 'Register', 'Webbyrom' ),
		esc_html__( 'Sign in or register', 'Webbyrom' )
	) );
            ...
            <div class="fs-header login-header">
                ...
                <h4 class="fs-center"><?php echo esc_attr( $atts['title_login'] ) ?></h4>
                    <div class="fs-subtitle">
                        <?php echo esc_html__('Login Using any of these options....','Webbyrom'); ?>
                    </div>        
            </div>
            <?php endif; ?>
                            ...
                            <form id="fs-login-form-<?php echo esc_attr( $atts['id'] ) ?>" class="fs-login-form" onsubmit="return false;">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="text" class="form-control required fs-full" name="username" placeholder="<?php echo esc_html__('Username','Webbyrom');?>" value="">
                                    </div> 
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="password" name="password" class="form-control required fs-full" placeholder="<?php echo esc_html__('Password','Webbyrom');?>" value="">
                                    </div> 
                                </div>     
                            
                                <div class="form-action">
                                    <input type="checkbox" name="remember" value="remember"><?php echo esc_html__('Remember me','Webbyrom')?>
                                    <a class="forgot" href="<?php echo wp_lostpassword_url(); ?>"><?php echo esc_html__('Lost your Password?','Webbyrom')?></a>
                                    <div class="fs-action">
                                ...
                                <div class="fs-created">
                                    <a href="#fs-register-form-<?php echo esc_attr( $atts['id'] ) ?>" data-active="register" class="fs-register"><?php echo esc_html__('Create an account','Webbyrom')?></a>
                                </div>
                            </form>
                            <?php if ( $can_register ): ?>
                    ...
                    <div class="form">
                        <div class="fs-register-form-wrap">
                            <form id="fs-register-form-<?php echo esc_attr( $atts['id'] ) ?>" class="fs-register-form" onsubmit="return false;">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                <input type="text" class="form-control required fs-full" name="fs_first_name" placeholder="<?php echo esc_html__('First Name','Webbyrom');?>" value="">
                                            </div> 
                                        </div>
                                        <div class="form-group">
                                            <div class="input-group">
                                                <input type="text" class="form-control required fs-full" name="fs_last_name" placeholder="<?php echo esc_html__('Last Name','Webbyrom');?>" value="">
                                            </div> 
                                        </div>
                                        <div class="form-group">
                                            <div class="input-group">
                                                <input type="email" class="form-control required fs-full" name="fs_email" placeholder="<?php echo esc_html__('Email','Webbyrom');?>" value="">
                                            </div> 
                                        </div>
                                        <div class="form-group">
                                            <div class="input-group">
                                                <input type="text" class="form-control required fs-full" name="fs_username" placeholder="<?php echo esc_html__('User name','Webbyrom');?>" value="">
                                            </div> 
                                        </div>
                                        <div class="form-group">
                                            <div class="input-group">
                                                <input type="password" class="form-control required fs-full" name="fs_password" placeholder="<?php echo esc_html__('Password','Webbyrom');?>" value="">
                                            </div> 
                                        </div>
                                        <div class="form-group">
                                            <div class="input-group">
                                                <input type="password" class="form-control required fs-full" name="fs_password_re" placeholder="<?php echo esc_html__('Confirm Password','Webbyrom');?>" value="">
                                            </div> 
                                        </div>
                                        ...
                                        <div class="fs-reg-signin fs-center">
                                            <p>Already have an account? <a href="#" class="fs-login"><?php echo esc_html__('Sign in now','Webbyrom');?></a></p>
                                        </div>
                                    </form>
