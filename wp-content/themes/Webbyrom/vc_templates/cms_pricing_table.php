            ...
            <?php if(!empty($pricing)): ?> 
             ...
             <?php  if( !empty($features)): ?>
                ...
                <?php if (isset($a_title)): ?>
                  <a href="<?php echo esc_url($a_href);?>" class="btn btn-theme-primary btn-pricing" style="<?php echo esc_attr($bg); ?> <?php echo esc_attr($cl); ?>"><?php echo !empty($a_title) ? esc_html($a_title): esc_html__('Purchase Plan','Webbyrom');?></a>
                <?php endif ?>
            <?php endif; 
        break;
        case 'style2':
