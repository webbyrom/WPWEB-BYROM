<?php 
    ...
    wp_localize_script(
        ...
        array(
            ...
            'masonry' => 'masonry',  
            'loadmore_text' => esc_html__( 'View All Project', 'Webbyrom' )
        )
    );
        ...
        <?php if( isset($atts['filter']) && $atts['filter'] == 1 ) :?>
            ...
            <div class="zo-masonry-filter">
                <ul class="zo-filter-category list-unstyled list-inline ">
                    ...
                    <li><a class="active" href="#" data-group="all" title="<?php echo esc_attr($count_posts->publish); ?>" style="<?php echo esc_attr($filter_color); ?>"><?php esc_html_e('All','Webbyrom')?></a></li>
                    ...
                    <?php 
                        if(has_post_thumbnail()):
                            if (!empty($g_style) && $g_style == 'style2') {
                                $thumbnails = wp_get_attachment_image_src( get_post_thumbnail_id(), 'Webbyrom-770-375' );  
                            }
                            else {
                                $thumbnails = wp_get_attachment_image_src( get_post_thumbnail_id(), 'Webbyrom-770-770' );
                            }
