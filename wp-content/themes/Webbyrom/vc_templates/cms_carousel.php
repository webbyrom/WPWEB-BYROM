...
<div class="cms-carousel owl-carousel next-prev-custom <?php echo esc_attr($atts['template']);?> <?php echo esc_attr($style); ?> " id="<?php echo esc_attr($atts['html_id']);?>">
    ...
    while($posts->have_posts()){
        ...
        <div class="cms-carousel-item">
            ...
            ?>
                <article id="post-<?php the_ID(); ?>" <?php post_class('Webbyrom-blog-grid wow fadeInUp'); ?>>
                                    ...
                                    <div class="blog-content">
                                        ...
                                        <?php if (!empty($atts['show_more']) && $atts['show_more'] == '1'): ?>
                                            <footer class="entry-footer">
                                                <a class="btn btn-theme-default" href="<?php the_permalink(); ?>"><?php esc_html_e('Read More', 'Webbyrom') ?><i class="fa fa-angle-double-right"></i></a>
                                            </footer><!-- .entry-footer -->
                                        <?php endif ?>
                                    </div><!-- .entry-content -->   
                                </div>          
