        ...
        while($posts->have_posts()){
            ...
            <div class="carousel-item vertical-item <?php echo implode(' ', $groups);?>">
        		<div class="item-media">
        			<article id="post-<?php the_ID(); ?>" <?php post_class('Webbyrom-blog'); ?>>
                        <div class=" row">
                            <div class="col-sm-6">
                                <div class="blog-wrap">
                                    
                                        <div class="post-thumbnail">
                                            <a href="<?php echo esc_url(get_permalink()) ; ?>"> <?php echo Webbyrom_get_image_croped(get_post_thumbnail_id(get_the_ID()),'770x378'); ?></a>       
                                        </div>
                                                ...
                                                <div class="blog-meta-before">
                                                    <ul class="meta-list">
                                                        <?php if (!empty($atts['blog_author']) && $atts['blog_author'] == '1'): ?>
                                                            <li class="meta-author"><?php echo esc_html__('Posted in','Webbyrom'); ?> <?php the_author_posts_link(); ?></li>
                                                        <?php endif; ?>
                                                        <?php if (!empty($atts['blog_comment']) && $atts['blog_comment'] == '1'): ?>
                                                           <?php  
                                                            $comments_number = get_comments_number();
                                                            if ( '1' === $comments_number ) {?>
                                                                <li class="detail-comment"><a href="<?php the_permalink(); ?>"><?php printf( _x( '01 comment', 'comments title', 'Webbyrom' ), get_the_title() ); ?></a></li>  
                                                           <?php }else{?>
