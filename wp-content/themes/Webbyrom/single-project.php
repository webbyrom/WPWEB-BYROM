...
$_get_sidebar = Webbyrom_post_sidebar();
global $opt_meta_options;
get_header(); ?>
<div id="primary" class="container ">
    <div class="row row-single <?php echo esc_attr($_get_sidebar); ?>">
        <div class="<?php Webbyrom_post_class(); ?>">
                            ...
                            <div class="entry-post-wrap ">
                                ...
                                <?php if ( has_post_thumbnail()): ?>
                                    <div class="post-thumbnail">
                                        <?php echo Webbyrom_get_image_croped(get_post_thumbnail_id(get_the_ID()),'1170x485'); ?>      
                                    </div>
                                <?php endif; ?>
                                                        ...
                                                        <div class="client">
                                                            <?php if (!empty($opt_meta_options['project_client_image']['url']) ): ?>
                                                                <div class="client-thumbnail">
                                                                     <?php 
                                                                     echo Webbyrom_get_image_croped($opt_meta_options['project_client_image']['id'],'thumbnail'); ?>
                                                    ...
                                                    <div class="information-item">
                                                        <?php if (!empty($opt_meta_options['project_link_demo']) ): ?>
                                                            <div class="information-item-wrap">
                                                                <span><?php echo esc_html__('Live Demo: ','Webbyrom'); ?></span><span><a href="<?php echo esc_attr($opt_meta_options['project_link_demo']); ?>" ><?php echo esc_attr($opt_meta_options['project_link_demo']); ?></a></span>
                                                            </div>
                                                        <?php endif ?>  
                                                        <?php if (!empty($opt_meta_options['project_start_date']) ): ?>
                                                            <div class="information-item-wrap">
                                                                <span><?php echo esc_html__('Start Date: ','Webbyrom'); ?></span><span><?php echo esc_attr($opt_meta_options['project_start_date']); ?></span>
                                                            </div>
                                                        <?php endif ?>  
                                                    </div>
                                                    <div class="information-item">
                                                        <?php if (!empty($opt_meta_options['project_category']) ): ?>
                                                            <div class="information-item-wrap">
                                                                <span><?php echo esc_html__('Category: ','Webbyrom'); ?></span><span><?php echo esc_attr($opt_meta_options['project_category']); ?></span>
                                                            </div>
                                                        <?php endif ?>  
                                                        <?php if (!empty($opt_meta_options['project_end_date']) ): ?>
                                                            <div class="information-item-wrap">
                                                                <span><?php echo esc_html__('End Date: ','Webbyrom'); ?></span><span><?php echo esc_attr($opt_meta_options['project_end_date']); ?></span>
                                                            </div>
                                                        <?php endif ?>  
                                                    </div>
                                                <?php endif ?>
                                ...
                                <div class="entry-text">
                                    ...
                                    the_content( sprintf(
                                        esc_html__( 'Continue reading %s <span class="meta-nav">&rarr;</span>', 'Webbyrom' ),
