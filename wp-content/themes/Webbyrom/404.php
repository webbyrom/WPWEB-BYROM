 ...
 */
$theme_options = Webbyrom_get_theme_option(); 
get_header(); ?>
        ...
        <div class="error-404 not-found">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <?php endif ?>
                    <h1 class="page-title-404"><?php echo !empty($theme_options['page_404_title'])? $theme_options['page_404_title'] : esc_html__( 'OH, CRAP', 'Webbyrom' ); ?></h1>
                    <p ><?php echo !empty($theme_options['page_404_message'])? $theme_options['page_404_message'] : esc_html__( 'We Can\'t Seem to Find the Page
You\'re Looking for.', 'Webbyrom' ); ?></p>
                    <?php if(isset($theme_options['page_404_button']) && $theme_options['page_404_button']=='1'): ?>
                        <div class="btn-action">
                            <a href="<?php echo esc_attr($theme_options['link_404_button']); ?>" class="btn-404 btn btn-theme-primary btn-round" style=""><?php echo esc_html__( 'VIEW ALL PROJECT', 'Webbyrom' )?></a>
                        </div>  
                    <?php endif; ?>
