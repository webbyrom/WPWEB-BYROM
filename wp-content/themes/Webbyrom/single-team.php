                                    ...
                                    <?php if ( has_post_thumbnail()): ?>
                                        <div class="header-left col-lg-5 col-md-6 col-sm-12">
                                            <div class="post-thumbnail">
                                                <?php echo Webbyrom_get_image_croped(get_post_thumbnail_id(get_the_ID()),'370x440'); ?> 
                                            </div> 
                                        </div>
                                    <?php endif; ?>
                                        ...
                                        <div class="header-right-wrap">
                                            ...
                                            <ul class="team-contact">
                                                <?php if (!empty($opt_meta_options['team_email'])): ?>
                                                    <li><span class="title"><?php echo esc_html__('EMAIL ADDRESS: ','Webbyrom') ?></span><span><?php echo esc_attr( $opt_meta_options['team_email'] ); ?></span></li>
                                                <?php endif; ?>
                                                <?php if (!empty($opt_meta_options['team_phone'])): ?>
                                                    <li><span class="title"><?php echo esc_html__('PHONE NO: ','Webbyrom') ?></span><span><?php echo esc_attr( $opt_meta_options['team_phone'] ); ?></span></li>
                                                <?php endif; ?>
                                                <?php if (!empty($opt_meta_options['team_location'])): ?>
                                                    <li><span class="title"><?php echo esc_html__('LOCATION: ','Webbyrom') ?></span><span><?php echo esc_attr( $opt_meta_options['team_location'] ); ?></span></li>
                                                <?php endif; ?>
                                            </ul>
                                            <div class="team-link">
