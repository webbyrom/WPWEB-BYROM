...
vc_map(array(
    ...
    "params" => array(
        ...
        array(
            'type'          => 'checkbox',
            'heading'       => esc_html__('Show Date','Webbyrom'),
            'param_name'    => 'blog_date',
            'value' => array(
                'Yes' => true
            ),
            'std' => true,
            'group'         => esc_html__('Blog Setting', 'Webbyrom')
        ), 
        array(
            'type'          => 'checkbox',
        ...
        array(
            'type'          => 'checkbox',
            'heading'       => esc_html__('Show Tag','Webbyrom'),
            'param_name'    => 'blog_tag',
            'value' => array(
                'Yes' => true
            ),
        ...
        array(
            'type'          => 'checkbox',
            'heading'       => esc_html__('Show Author','Webbyrom'),
        ...
        array(
            'type'          => 'checkbox',
            'heading'       => esc_html__('Show Comment Count','Webbyrom'),
