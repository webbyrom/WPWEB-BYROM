...
vc_map(array(
    ...
    'description' => esc_html__('Add clients', 'Webbyrom'),
    'params' => array(
        array(
            'type'          => 'param_group',
            'heading'       => esc_html__( 'Add your Client', 'Webbyrom' ),
            'param_name'    => 'values',
            'params' => array(
                array(
                    'type'          => 'attach_image',
                    'heading'       => esc_html__( 'Author Image', 'Webbyrom' ),
            ...
            'group' => esc_html__('Client Item','Webbyrom')
        ),
        /* Carousel Settings */
        array(
            'type'              => 'dropdown',
