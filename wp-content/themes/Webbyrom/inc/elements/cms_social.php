...
vc_map(array(
    ...
    "params" => array(  
        array(
            'type' => 'dropdown',
            'heading' => esc_html__( 'Style', 'Webbyrom' ),
            "param_name" => "style",
            'value' => array(
        ...
        array(
            'type' => 'param_group',
            'heading' => esc_html__( 'Options', 'Webbyrom' ),
            'param_name' => 'options',
            'description' => esc_html__( 'Enter values for plan option', 'Webbyrom' ),
            'value' => urlencode( json_encode( array(
                array(
                    'values' => esc_html__( 'Option', 'Webbyrom' ),
                ),
            ) ) ),
            'params' => array(
                array(
                ...
                array(
                    "type" => "textfield",
                    "heading" =>esc_html__("Social Link",'Webbyrom'),
                    "param_name" => "social_link",
                ),
                array(
                    "type" => "textfield",
                    "heading" =>esc_html__("Icon class (fa fa-facebook,... for Awesome Font)",'Webbyrom'),
