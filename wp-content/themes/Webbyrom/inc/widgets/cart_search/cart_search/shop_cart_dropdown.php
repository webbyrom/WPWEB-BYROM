                ...
                <?php foreach ($products as $product) :
                    ...
                    <li class="<?php echo esc_attr(apply_filters('woocommerce_mini_cart_item_class', 'mini_cart_item')); ?>">
                        ...
                        echo apply_filters('woocommerce_cart_item_remove_link', sprintf(
                            ...
                            $remove_link,
                            esc_html__('Remove this item', 'Webbyrom'),
                            $remove_id,
                            $sku
                        ));
                        ?>
                        <div class="item-wrap">
                            ...
                            <div class="product-desc">
                                ...
                                <?php echo Webbyrom_html($data); ?>
                                <?php echo Webbyrom_html($quantity); ?>
                            </div>
                        </div>
                    </li>
                <?php endforeach; ?>
            <?php else : ?>
                <li class="cart-list clearfix"><?php esc_html_e('No products in the cart.', 'Webbyrom'); ?></li>
            <?php endif; ?>
        </ul>
    </div>
    <p class="total">
        <span class="total"><?php esc_html_e('Total: ', 'Webbyrom'); ?>
            <span><?php echo Webbyrom_html($cart_subtotal); ?></span></span>
    </p>
    <p class="button">
        <a href="<?php echo esc_url($cart_url) ?>"
           class="btn btn-theme-primary "><?php esc_html_e('Cart', 'Webbyrom'); ?></a>
        <?php if (!$is_cart_empty): ?>
            <a href="<?php echo esc_url($checkout_url) ?>"
               class="btn btn-theme-primary "><?php esc_html_e('Checkout', 'Webbyrom'); ?></a>
        <?php endif; ?>
    </p>
