...
function Webbyrom_register_social_widget(){
    register_ef4_widget('Cms_Socials_Widget');
}

add_action( 'widgets_init', 'Webbyrom_register_social_widget' );
...
class Cms_Socials_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            ...
            esc_html__('Cms Socials', 'Webbyrom'), // Name
            array('description' => esc_html__('Socials Widget', 'Webbyrom')) // Args
        );
    }
    ...
    function widget($args, $instance) {
        ...
        $title = apply_filters('widget_title', empty($instance['title']) ? esc_html__('Be Social', 'Webbyrom' ) : $instance['title'], $instance, $this->id_base);
        }
    ...
    function form( $instance ) {
         ...
         ?>
         <p><label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e( 'Title:', 'Webbyrom' ); ?></label>
         ...
         ?>
             <p>
             <label for="<?php echo esc_attr($this->get_field_id('icon_class_'.$i)); ?>"><?php esc_html_e( 'Icon class', 'Webbyrom' ); ?> <?php echo esc_attr($i);?></label>
             ...
             <p>
             <label for="<?php echo esc_attr($this->get_field_id('link_'.$i)); ?>"><?php esc_html_e( 'Link', 'Webbyrom' ); ?> <?php echo esc_attr($i);?></label>
         ...
         ?>   
         <p><label for="<?php echo esc_attr($this->get_field_id('extra_class')); ?>"> <?php esc_html_e( 'Extra Class:', 'Webbyrom' ); ?></label>
