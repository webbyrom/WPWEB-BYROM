...
function Webbyrom_register_recent_post_widget_v2(){
    register_ef4_widget('CS_Recent_Post_Widget_V2');
}
add_action( 'widgets_init', 'Webbyrom_register_recent_post_widget_v2' );

class CS_Recent_Post_Widget_V2 extends WP_Widget {
 
    function __construct() {
        parent::__construct(
            'cs_recent_post_v2',esc_html__( 'CS Recent Posts V2', 'Webbyrom' ),array('description' => esc_html__( 'Recent Posts Widget.', 'Webbyrom' )) 
        );
                               ...
                               <?php
                                ...
                                <div class="entry-main">
                                    ...
                                    <?php
                                        if ( comments_open() ) :
                                            comments_popup_link(
                                              esc_html__('Leave a Comment', 'Webbyrom'),
                                              esc_html__('One Comment', 'Webbyrom'),
                                              esc_html__('% Comments', 'Webbyrom'),
                                              esc_html__('Read all Comments', 'Webbyrom')
                                             );
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('show_comment')); ?>"><?php esc_html_e( 'Show Comment:', 'Webbyrom' ); ?></label>
