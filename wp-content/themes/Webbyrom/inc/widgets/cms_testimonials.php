...
class Cms_Testimonials_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            ...
            esc_html__( 'Cms Testimonials', 'Webbyrom' ), // Name
            array(
    ...
    function form( $instance ) {
        ...
        <p>
             <label for="<?php echo esc_attr( $this->get_field_id( 'name' ) ); ?>"><?php esc_html_e( 'Name:', 'Webbyrom' ); ?></label>
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'name' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'name' ) ); ?>" type="text" value="<?php echo esc_attr($name); ?>" />
        </p>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'position' ) ); ?>"><?php esc_html_e( 'Position:', 'Webbyrom' ); ?></label>
...
add_action( 'widgets_init', 'Webbyrom_register_testimonial_widget' );
function Webbyrom_register_testimonial_widget(){
