...
$meta_options = Webbyrom_get_meta_option();
$border ='';
$fullwidth = 'container';
 ?>
 <?php  
...
<div id="cshero-header" class="<?php Webbyrom_header_class('header-main'); ?> <?php echo esc_html($border); ?>" style ="<?php echo esc_attr($border_color) ?>">
    <div class="<?php echo esc_attr($fullwidth); ?>">
        <div class="header-main-wrap">
            <div id="cshero-header-logo" class="site-branding header-main-center">
                <?php Webbyrom_header_logo2(); ?>
            ...
            <div class="header-main-right-menu">
                <div id="cshero-header-navigation" class="header-navigation">
                    <nav id="site-navigation" class="collapse main-navigation">
                        <?php Webbyrom_header_navigation(); ?>
                    </nav> 
                </div>
            </div>
        </div> 
