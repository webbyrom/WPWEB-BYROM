 ...
 * @return array
 */
function Webbyrom_get_terms($taxonomy = 'category', $slug = true, $options = array()){
 ...
 * @return array
 */
function Webbyrom_get_nav_menu(){
...
function Webbyrom_get_list_rev_slider() {
    if (class_exists('RevSlider')) {
        ...
        if ($arrSliders) {
            ...
            $revsliders[esc_html__('No sliders found', 'Webbyrom')] = 0;
        }
    return $revsliders;
    }
