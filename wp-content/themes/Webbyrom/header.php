...
<?php $transparent = '';
 ...
 ?>
<div id="page" class="hfeed site <?php Webbyrom_general_class();?>">
	<?php Webbyrom_revo_header(); ?>	
		<header id="masthead" class="site-header <?php Webbyrom_header_layout_class('header-default');?> <?php echo esc_attr($transparent); ?>" >
			<?php Webbyrom_header(); ?>
		</header><!-- #masthead -->
    <?php Webbyrom_page_title(); ?> <!-- #page-title -->
