...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="entry-post-wrap ">
		<div class="entry-text">
			<?php Webbyrom_post_detail_before(); ?>
			<?php if ( has_post_thumbnail()): ?>
				<div class="post-thumbnail">
					<a href="#"><?php Webbyrom_post_thumbnail(); ?></a>		
				</div>
			<?php endif; ?>	
			<header class="entry-header">
			<?php if ( (!empty($opt_theme_options['single_page_title_layout']) && $opt_theme_options['single_page_title_layout']  == 7 ) || 
						((empty($opt_theme_options['single_page_title_layout']) || (!empty($opt_theme_options['single_page_title_layout']) && $opt_theme_options['single_page_title_layout'] < 2 ) ) && $opt_theme_options['page_title_layout'] == 7)  ): ?>
				<?php the_title( '<h2 class="entry-title">', '</h2>' ); ?>
			<?php endif; ?>	
				<?php Webbyrom_post_detail_after(); ?>
			</header><!-- entry-header  -->	
